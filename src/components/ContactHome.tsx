...
export default function ContactHome() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 70; i++) {
      particles.push({
        ...
        }, ${Math.floor(Math.random() * 50)}, ${Math.random() * 0.2 + 0.1})`,
    ...
    for (let i = 0; i < 10; i++) {
      particles.push({
        ...
        color: `rgba(255, ${
          Math.floor(Math.random() * 100) + 100
        }, ${Math.floor(Math.random() * 50)}, 0.03)`,
      ...
      particles.forEach((p, index) => {
        ...
        if (index % 5 === 0) {
          ...
          gradient.addColorStop(
            0,
            p.color.replace(/[\d.]+\)$/g, `${opacity * 0.5})`)
          );
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-black text-white py-28 px-4 md:px-8 relative overflow-hidden"
    >
      {/* Canvas background */}
      <canvas
        id="contact-canvas"
      ...
      <div
        className={`absolute top-0 left-0 w-0 h-1 bg-gradient-to-r from-transparent via-orange-500 to-transparent transition-all duration-1000 ${
          isVisible ? "w-full" : ""
        }`}
      ></div>
      <div
        className={`absolute bottom-0 left-0 w-0 h-1 bg-gradient-to-r from-transparent via-orange-500 to-transparent transition-all duration-1000 delay-300 ${
          isVisible ? "w-full" : ""
        }`}
      ></div>
      ...
      <div className="absolute top-0 right-0 w-1/3 h-1/3 overflow-hidden pointer-events-none">
        <div
          className={`absolute top-0 right-0 w-1 h-[200%] bg-gradient-to-b from-transparent via-orange-500/30 to-transparent transform rotate-45 translate-x-full transition-transform duration-1000 ${
      ...
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 overflow-hidden pointer-events-none">
        <div
          className={`absolute bottom-0 left-0 w-1 h-[200%] bg-gradient-to-b from-transparent via-orange-500/30 to-transparent transform -rotate-45 -translate-x-full transition-transform duration-1000 delay-300 ${
            isVisible ? "translate-x-0" : ""
          }`}
        ></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <h2 className="text-5xl md:text-7xl font-bold mb-8 relative inline-block text-gradient">
              Get In Touch
              <span
                className={`absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-0 h-1 bg-gradient-to-r from-orange-600 via-orange-500 to-orange-300 transition-all duration-1000 delay-500 ${
                  isVisible ? "w-2/3" : ""
                }`}
              ></span>
            </h2>
            <p className="text-gray-400 max-w-2xl text-lg md:text-xl">
              ...
              love to hear from you and bring your vision to life through
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-10">
            <div
              className={`grid gap-6 transform transition-all duration-1000 ${
                isVisible
            ...
            >
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-black/80 via-black/95 to-black/90 backdrop-blur-md border border-orange-500/20 rounded-3xl p-8 hover:border-orange-500/40 transition-all duration-500 group shadow-[0_10px_50px_-12px_rgba(255,115,0,0.15)]">
                ...
                <div className="absolute top-0 left-0 w-16 h-16 overflow-hidden">
                  <div
                    className={`absolute top-0 left-0 w-1 h-8 bg-orange-500/50 transition-all duration-700 delay-100 ${
                      isVisible ? "h-8" : "h-0"
                    }`}
                  ></div>
                  <div
                    className={`absolute top-0 left-0 h-1 w-8 bg-orange-500/50 transition-all duration-700 delay-100 ${
                      isVisible ? "w-8" : "w-0"
                    }`}
                  ></div>
                </div>
                <div className="absolute bottom-0 right-0 w-16 h-16 overflow-hidden">
                  <div
                    className={`absolute bottom-0 right-0 w-1 h-8 bg-orange-500/50 transition-all duration-700 delay-300 ${
                      isVisible ? "h-8" : "h-0"
                    }`}
                  ></div>
                  <div
                    className={`absolute bottom-0 right-0 h-1 w-8 bg-orange-500/50 transition-all duration-700 delay-300 ${
                      isVisible ? "w-8" : "w-0"
                    }`}
                  ></div>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-black/40 border border-orange-500/10 group-hover:border-orange-500/20 transition-all duration-300 hover:bg-black/60 hover:shadow-[0_0_15px_rgba(255,115,0,0.1)] hover:-translate-y-0.5">
                    ...
                    <div>
                      ...
                      <p className="text-white">Marrakesh, Morocco</p>
                      </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-orange-500/10">
                  ...
                  <div className="flex justify-center gap-4">
                    {[
                      {
                        Icon: Instagram,
                        link: "https://www.instagram.com/amine._.rihani?igsh=OHpyM2Zldmd0ZDYy&utm_source=qr",
                      },
                      {
                        Icon: Linkedin,
                        link: "https://www.linkedin.com/in/amine-rihani-66487a216?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
                      },
                    ].map(({ Icon, link }, index) => (
                      <a
                        key={index}
          ...
          >
            <div className="relative overflow-hidden bg-gradient-to-br from-black/80 via-black/95 to-black/90 backdrop-blur-md border border-orange-500/20 rounded-3xl p-8 md:p-10 hover:border-orange-500/30 transition-all duration-500 shadow-[0_10px_50px_-12px_rgba(255,115,0,0.15)] hover:shadow-[0_20px_60px_-15px_rgba(255,115,0,0.2)]">
              ...
              <div className="absolute top-0 right-0 w-16 h-16 overflow-hidden">
                <div
                  className={`absolute top-0 right-0 w-1 h-8 bg-orange-500/50 transition-all duration-700 delay-200 ${
                    isVisible ? "h-8" : "h-0"
                  }`}
                ></div>
                <div
                  className={`absolute top-0 right-0 h-1 w-8 bg-orange-500/50 transition-all duration-700 delay-200 ${
                    isVisible ? "w-8" : "w-0"
                  }`}
                ></div>
              </div>
              <div className="absolute bottom-0 left-0 w-16 h-16 overflow-hidden">
                <div
                  className={`absolute bottom-0 left-0 w-1 h-8 bg-orange-500/50 transition-all duration-700 delay-400 ${
                    isVisible ? "h-8" : "h-0"
                  }`}
                ></div>
                <div
                  className={`absolute bottom-0 left-0 h-1 w-8 bg-orange-500/50 transition-all duration-700 delay-400 ${
                    isVisible ? "w-8" : "w-0"
                  }`}
                ></div>
              </div>
                      ...
                      <div className="space-y-2 relative group">
                        ...
                        >
                          <span className="relative">
                            Your Name
                            <span
                              className={`absolute -bottom-px left-0 w-0 h-0.5 bg-gradient-to-r from-orange-500 to-orange-300 transition-all duration-300 ${
                                activeField === "name"
                                  ? "w-full"
                                  : "group-hover:w-full"
                              }`}
                        ...
                        <div className="relative">
                          ...
                          />
                          <div
                            className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-transparent via-orange-500 to-transparent transition-all duration-500 ${
                              activeField === "name"
                                ? "w-[calc(100%-24px)]"
                                : ""
                            }`}
        ...
        {/* Decorative dots */}
        <div
          className={`hidden md:block absolute -right-4 top-1/4 grid grid-cols-3 gap-2 transition-all duration-1000 delay-700 ${
        ...
        <div
          className={`hidden md:block absolute -left-4 bottom-1/4 grid grid-cols-3 gap-2 transition-all duration-1000 delay-700 ${
            isVisible
