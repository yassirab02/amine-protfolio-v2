        ...
        >
          ...
          <div className="mt-8 flex flex-col gap-6">
            ...
            <div className="mt-8 flex flex-col gap-4">
              <button
                className="rounded-md bg-gradient-to-r from-purple-600 to-purple-500 px-4 py-2 text-white shadow-[0_4px_10px_rgba(124,58,237,0.3)] hover:shadow-[0_6px_15px_rgba(124,58,237,0.4)]"
                title="Hire Me"
              >
                Hire Me
              </button>
